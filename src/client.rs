...
pub struct Client {
    ...
    pub(crate) message_bus: Arc<Mutex<dyn MessageBus + Sync + Send>>,
...
impl Client {
    ...
    fn do_connect(client_id: i32, message_bus: Arc<Mutex<dyn MessageBus + Sync + Send>>) -> Result<Client, Error> {
